...
var cc =
{
    ...
    showbanner: function () {
        ...
        // Terminal8
        if (cc.localeLanguage()) {
            lang = cc.localeLanguage();
        } else {
            lang = 0;
        }
        jQuery('#cc-notification-wrapper h2').append(' - <a href="'+lang+'?id=' + cc.settings.idPageInformation + '">' +cc.strings.informationCookies+'</a>');
