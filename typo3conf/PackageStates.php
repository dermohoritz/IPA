...
return [
    'packages' => [
        ...
        'aip_cookie_law' => [
            'packagePath' => 'typo3conf/ext/aip_cookie_law/',
        ],
        'gridelements' => [
        ...
        't8_jetpack' => [
            'packagePath' => 'typo3conf/ext/t8_jetpack/',
        ],
        'rte_ckeditor_fontawesome' => [
            'packagePath' => 'typo3conf/ext/rte_ckeditor_fontawesome/',
        ],
        't8_custom' => [
            'packagePath' => 'typo3conf/ext/t8_custom/',
        ],
        'ke_search' => [
